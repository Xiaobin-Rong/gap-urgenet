...
# Github Source: https://github.com/NVIDIA/BigVGAN/
...
def feature_loss(
    ...
    return loss  # This equates to lambda=2.0 for the feature matching loss
...
if __name__ == "__main__":
    loss_func = MultiScaleMelSpectrogramLoss()
    
    
    x = torch.randn(1, 1, 16000*5)
    y = torch.randn(1, 1, 16000*5)
    
    loss = loss_func(x, y, 48000)
    # loss0 = loss_func0(x, y)
